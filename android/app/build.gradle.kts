...
android {
    ...
    buildTypes {
        ...
        named("profile") {
            signingConfig = signingConfigs.create("profile") {
        ...
        named("release") {
            sentryPublish = dartEnvironmentVariables["publish"] as Boolean //flutter build apk --dart-define=publish=true
            //packagingOptions {
            //   doNotStrip = '**/*.so'
            //} 
...
val sentryKeystore = rootProject.file("../private/clashmi/android/sign/sentry.properties")
val sentryProp = Properties().apply {
